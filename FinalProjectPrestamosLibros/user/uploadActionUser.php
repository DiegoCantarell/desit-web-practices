...
<body>
    ...
    echo "<h2>Upload a Book!</h2>";
    echo "<h2>Fill the following fields to upload your book</h2>";

    echo "<form action = 'uploadActionUserBackend.php' method = 'POST'>";
        ...
        echo "<div class='form-group'>";
            ...
            echo "<input type='text' id='editorial' name='editorial'  required>";
        echo "</div>";
        echo "<div class='form-group'>";
