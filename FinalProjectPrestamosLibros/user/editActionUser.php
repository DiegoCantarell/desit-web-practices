...
<body>
    ...
    $password = $users -> getUserPassword($name);
    $cellphone = $users -> getUserCellphone($name);
    echo "<h2>Edit Your Profile Information</h2>";
    echo "<form action = 'editActionUserBackend.php' method = 'POST'>";
      ...
      echo "</div>";
      echo "<div class='form-group'>";
        echo "<label for='cellphone'>Cellphone:</label>";
        echo "<input type='text' id='cellphone' name='cellphone' value =$cellphone required>";
      echo "</div>";
      echo "<div class='form-group'>";
        echo "<button type='submit' name = 'send' >Submit </button>";
      echo "</div>";
    echo "</form>";
