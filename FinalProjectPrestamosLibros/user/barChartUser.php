...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <a href="barChartUser.php" class="nav-item nav-link active">Our Users Points</a>
    ...
    <?php
        ...
        $users = new users();
        $nombresEtiquetas = $users -> getAllUsernamesForBarChart($arrayNames);
        $datos = $users -> getAllUserPointsForBarChart($arrayEtiquetas);
        //for ($i = 0; $i < 7; $i++)
