...
<body>
    ...
    <?php
        ...
        $borrow_start_date = $_REQUEST['borrow_start_date'];
        $borrow_end_date = $_REQUEST['borrow_end_date'];

        echo "<br>The name of the user is: $name<br>";
        echo "<br>The id is: $id_book<br>";
        echo "<br>The Title is: $title <br>";
        echo "<br>The Availability is: $availability <br>";
        echo "<br>The borrow_start_date is: $borrow_start_date <br>";
        echo "<br>The borrow_end_date is: $borrow_end_date <br>";

        $books -> addBorrow($id_book,$borrower,$borrow_start_date,$borrow_end_date);
